                    ...
                    if(!readLineEscape){
                        ...
                        ////////////////////////////////////////////LOGIN///////////////////////////////////////////////////
                            ...
                            if(!flagConnected){
                                ...
                                try
                                {
                                    if(!(1023<Integer.parseInt(userData[3]) && Integer.parseInt(userData[3])<65536)){
                                        consoleManager.println("Port range error, Try again...\n");
                                    }
                                    else{
                                        try
                                        {
                                ...
                                {
                                       consoleManager.println("Put appropriate number as your port number...\n");
                                }
